...
!function (a) {
    ...
    jQuery.extend(!0, t, {
        animcompleted: function (a, e) {
            ...
            var x = y, T = h(a, n, "in", !0), L = a.data("_pw") || a.closest(".tp-parallax-wrap"), W = a.data("_lw") || a.closest(".tp-loop-wrap"), C = a.data("_mw") || a.closest(".tp-mask-wrap"), j = a.data("responsive") || "on", I = a.data("responsive_offset") || "on", R = a.data("basealign") || "grid", k = "grid" === R ? n.width : n.ulw, _ = "grid" === R ? n.height : n.ulh, S = jQuery("body").hasClass("rtl");
            ...
            if ("off" == Q || k < n.hideCaptionAtLimit && "on" == a.data("captionhidden") || k < n.hideAllCaptionAtLimit ? a.addClass("tp-hidden-caption") : a.removeClass("tp-hidden-caption"), a.data("layertype", "html"), 0 > r && (r = 0), void 0 != a.data("thumbimage") && void 0 == a.data("videoposter") && a.data("videoposter", a.data("thumbimage")), a.find("img").length > 0) {
                ...
                var O = M.data("ww"), H = M.data("hh"), B = "slide" == R ? n.ulw : n.gridwidth[n.curWinRange], A = "slide" == R ? n.ulh : n.gridheight[n.curWinRange], O = p(M.data("ww"), n)[n.curWinRange] || p(M.data("ww"), n) || "auto", H = p(M.data("hh"), n)[n.curWinRange] || p(M.data("hh"), n) || "auto", F = "full" === O || "full-proportional" === O, D = "full" === H || "full-proportional" === H;
            ...
            if ("slide" === R && (r = 0, u = 0), a.hasClass("tp-videolayer") || a.find("iframe").length > 0 || a.find("video").length > 0) {
                ...
                var M = a.find("iframe") ? a.find("iframe") : M = a.find("video"), V = a.find("iframe") ? !1 : !0, N = a.hasClass("coverscreenvideo");
            ...
            var J = 0 == E.voa.length ? 0 : E.voa, K = 0 == E.hoa.length ? 0 : E.hoa, aa = 0 == E.elx.length ? 0 : E.elx, ea = 0 == E.ely.length ? 0 : E.ely, ta = a.outerWidth(!0), ia = a.outerHeight(!0);
            0 == ta && 0 == ia && (ta = n.ulw, ia = n.ulh);
            var na = "off" !== I ? parseInt(J, 0) * n.bw : parseInt(J, 0), oa = "off" !== I ? parseInt(K, 0) * n.bw : parseInt(K, 0), ra = "grid" === R ? n.gridwidth[n.curWinRange] * n.bw : k, da = "grid" === R ? n.gridheight[n.curWinRange] * n.bw : _;
            ...
            var sa = a.data("lasttriggerstate"), la = a.data("triggerstate"), pa = a.data("start") || 100, ha = a.data("end"), ca = b ? 0 : "bytrigger" === pa || "sliderenter" === pa ? 0 : parseFloat(pa) / 1e3, ga = aa + r, ma = ea + u, ua = a.css("z-Index");
            ...
            var va = a.data("timeline") ? a.data("timeline").time() : 0, fa = void 0 !== a.data("timeline") ? a.data("timeline").progress() : 0, wa = a.data("timeline") || new punchgs.TimelineLite({smoothChildTiming: !0});
            if (fa = jQuery.isNumeric(fa) ? fa : 0, wa.pause(), 1 > fa && 1 != a.data("outstarted") || 2 == T || b) {
                ...
                var xa = new Object, Ta = void 0 != a.data("transform_in") ? a.data("transform_in").match(/\(R\)/gi) : !1;
                if (!a.data("$anims") || b || Ta) {
                    var La = i(), Wa = i(), Ca = o(), ja = void 0 !== a.data("transform_hover") || void 0 !== a.data("style_hover");
